  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (m == 1073741824)
    {
      ...
      int i2 = k - m;
      int i1 = View.MeasureSpec.makeMeasureSpec((int)(0.8F * i), -2147483648);
      ...
      if (j != 1073741824) {
        setMeasuredDimension(i, Math.max(n, m + this.mCurrText.getMeasuredHeight()));
      } else {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    int i9 = Math.max(Math.max(i6, i7), i8);
    i6 = i9 - i6;
    i7 = i9 - i7;
    i8 = i9 - i8;
    int i11 = i6 + this.mPrevText.getMeasuredHeight();
    int i10 = i7 + this.mCurrText.getMeasuredHeight();
    ...
    m = i2 + m;
    i5 = i4 + this.mPrevText.getMeasuredHeight();
    localTextView2.layout(i2, i4, m, i5);
    k = Math.max(j - k - i, i1 + this.mScaledTextSpacing);
    TextView localTextView1 = this.mNextText;
    m = k + i;
    i = i3 + this.mNextText.getMeasuredHeight();
    localTextView1.layout(k, i3, m, i);
