  ...
  implements TabHost.OnTabChangeListener
{
  ...
  private void initFragmentTabHost(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if (findViewById(16908307) == null)
    {
      ...
      Object localObject2 = new TabWidget(paramContext);
      ((TabWidget)localObject2).setId(16908307);
      ((TabWidget)localObject2).setOrientation(0);
      ((LinearLayout)localObject1).addView((View)localObject2, new LinearLayout.LayoutParams(-1, -2, 0.0F));
      localObject2 = new FrameLayout(paramContext);
      ((FrameLayout)localObject2).setId(16908305);
      ((LinearLayout)localObject1).addView((View)localObject2, new LinearLayout.LayoutParams(0, 0, 0.0F));
      localObject2 = new FrameLayout(paramContext);
      this.mRealTabContent = ((FrameLayout)localObject2);
      this.mRealTabContent.setId(this.mContainerId);
      ((LinearLayout)localObject1).addView((View)localObject2, new LinearLayout.LayoutParams(-1, 0, 1.0F));
    }
  }
  ...
  protected void onAttachedToWindow()
  {
    ...
    for (int i = 0;; i++)
    {
      ...
      {
        this.mAttached = true;
        localFragmentTransaction = doTabChanged(str, localFragmentTransaction);
