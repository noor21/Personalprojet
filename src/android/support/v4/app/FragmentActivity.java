  ...
  extends Activity
{
  ...
  private static String viewToString(View paramView)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        String str2 = ((Resources)localObject).getResourcePackageName(i3);
        for (;;)
        {
          String str1 = ((Resources)localObject).getResourceTypeName(i3);
  ...
  public View onCreateView(String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    if ("fragment".equals(paramString))
    {
      ...
      if ((localTypedArray2 != -1) || (localTypedArray1 != -1) || (localObject != null))
      {
        ...
        if (FragmentManagerImpl.DEBUG) {
          Log.v("FragmentActivity", "onCreateView: id=0x" + Integer.toHexString(localTypedArray1) + " fname=" + str + " existing=" + localFragment);
        }
        if (localFragment != null)
        {
          ...
          {
            throw new IllegalArgumentException(paramAttributeSet.getPositionDescription() + ": Duplicate id 0x" + Integer.toHexString(localTypedArray1) + ", tag " + (String)localObject + ", or parent id 0x" + Integer.toHexString(localTypedArray2) + " with another fragment for " + str);
          }
        }
        else
        {
