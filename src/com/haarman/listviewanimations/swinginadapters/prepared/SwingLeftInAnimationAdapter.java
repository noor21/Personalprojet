...
public class SwingLeftInAnimationAdapter
  extends SingleAnimationAdapter
{
  private final long mAnimationDelayMillis;
  private final long mAnimationDurationMillis;
  
  public SwingLeftInAnimationAdapter(BaseAdapter paramBaseAdapter)
  {
    this(paramBaseAdapter, 100L, 300L);
  }
  
  public SwingLeftInAnimationAdapter(BaseAdapter paramBaseAdapter, long paramLong)
  {
    this(paramBaseAdapter, paramLong, 300L);
  }
  
  public SwingLeftInAnimationAdapter(BaseAdapter paramBaseAdapter, long paramLong1, long paramLong2)
  {
  ...
  protected Animator getAnimator(ViewGroup paramViewGroup, View paramView)
  {
    ...
    arrayOfFloat[0] = (0 - paramViewGroup.getWidth());
    arrayOfFloat[1] = 0.0F;
 ...
 * Qualified Name:     com.haarman.listviewanimations.swinginadapters.prepared.SwingLeftInAnimationAdapter
