  ...
  implements Serializable
{
  ...
  {
    String str2 = FilenameUtils.getExtension(paramFile1.getName());
    String str1 = FilenameUtils.getExtension(paramFile2.getName());
    return this.caseSensitivity.checkCompareTo(str2, str1);
  }
